...
class LMDI:
    ...
    def __init__(self, years, base_year=2010, state=False):
        ...
        self.industries = [11, '111CA', '113FF', 21, 211, 212, 213, 23, '311FT',
        ...
        def map_naics(df):
          """
          Map NAICS codes from county data to BEA industries.
          """

          # Make 4-digit NAICS code and then aggregate. Join with
          #BEA-NAICS.csv to get BEA codes in self.industries
        ...
        if self.state == False:
            ...
            activity_params = {'UserID': api_key, 'method': 'GetData',
                               ...
                               'TableID': '208','Industry': self.industries,
                               'Year': years}

            # import and group energy data by state
            self.energy_data =
